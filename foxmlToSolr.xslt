...
vagrant@brandon-vagrant-nyam:/usr/local/fedora/tomcat/webapps/fedoragsearch/WEB-INF/classes/fgsconfigFinal/index/FgsIndex$ sudo service fedora stop
fedora stop/waiting
vagrant@brandon-vagrant-nyam:/usr/local/fedora/tomcat/webapps/fedoragsearch/WEB-INF/classes/fgsconfigFinal/index/FgsIndex$ sudo service fedora start
fedora start/running, process 4406
vagrant@brandon-vagrant-nyam:/usr/local/fedora/tomcat/webapps/fedoragsearch/WEB-INF/classes/fgsconfigFinal/index/FgsIndex$ cat
^C
vagrant@brandon-vagrant-nyam:/usr/local/fedora/tomcat/webapps/fedoragsearch/WEB-INF/classes/fgsconfigFinal/index/FgsIndex$ cat foxmlToSolr.xslt
<?xml version="1.0" encoding="UTF-8"?>
<!-- We need all lower level namespaces to be declared here for exclude-result-prefixes attributes
     to be effective -->
<xsl:stylesheet version="1.0"
